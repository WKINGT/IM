...
import im.xgs.net.protocol.entity.req.login.ReconnectionReq;
import im.xgs.net.protocol.entity.resp.login.ReconnectionResp;
...
public class RecHandler12 extends RecHandler {
	...
	public Object exec(String uuid,String msg, boolean isWeb, String client, Channel channel)
			throws ImException {
		ReconnectionReq entity = null;
		try {
			entity = JSON.parseObject(msg, ReconnectionReq.class);
		} catch (Exception e) {
...
//		String uuid = UUIDHexGenerator.getId();
		...
		short opera = Protocol.Login.RECONNECT;
		
		ReconnectionResp in = new ReconnectionResp();
		in.setCode(0);
